                                    ...
                                    <tbody class="align-middle">
                                        {this.state.dataList.map((user) => (
                                            <tr>
                                                ...
                                                <td>{user.state}</td>
                                                {user.state === 'active' &&
                                                    <td><button className='btn btn-danger' onClick={async () => { await this.updateStatus(user._id, "deactive"); }}> Deactive User </button></td>
                                                }
                                                {user.state === 'deactive' &&
                                                    <td><button className='btn btn-success' onClick={async () => { await this.updateStatus(user._id, "active"); }}> Active User </button></td>
                                                }
                                            </tr>
                                        ))}
                                    </tbody>
