                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className='col-8 offset-1'>
                            <center>
                                <h1 className='mt-4' style={{ fontWeight: "bold" }}> Add category </h1>
                            </center>
                            <form>
                                <div className="mb-3">
                                ...
                                <br />
                                <button type="button" className='btn btn-primary col-12' onClick={async () => { await this.addCato(); }}>ADD</button>
                                <br></br>
