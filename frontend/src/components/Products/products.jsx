  ...
  renderProducts() {
    return this.state.dataList.map((product) => (
      ...
      <div className="product-card" key={product.id}>
        <img src="https://www.eatlanka.com/wp-content/uploads/2021/11/Chocolate-cake-recipe-1200a.jpg" alt={product.name} />
        <h3>{product.name}</h3>
        <center>
        ...
        <div className='row'>
          <a href={"/products/singleProduct/" + product._id} className="buy-now-button col-12 text-white mt-3">View Product</a>
        </div>
      ...
      <div style={styles} >
        ...
        <div style={{ height: "800px" }}>
          ...
          <div className="container-fluid mt-5" >
            ...
            <hr style={{ backgroundColor: "white" }} />          <div className="search-bar" >
            </div>
