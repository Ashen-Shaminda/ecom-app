    ...
    <>
      <Router>
        <Routes>
          ...
          <Route exact path="/products/cart" element={<Cart />} />
          <Route exact path="/products/singleProduct/:id" element={<SingleProduct />} />
          <Route exact path="/products/checkOut" element={<CheckOut />} />
          <Route exact path="/products/UserOderHistory" element={<UserOderHistory />} />
          <Route exact path="/products/OrderView/:orderid" element={<OrderView />} />
          <Route exact path="/products/UserAddReview/:productid" element={<UserAddReview />} />

          <Route exact path="/AdminDashboard/admin" element={<Admin />} />
          <Route exact path="/AdminDashboard/addStores" element={<AddStores />} />
          <Route exact path="/AdminDashboard/addCato" element={<AddCato />} />
          <Route exact path="/AdminDashboard/catoList" element={<CategoryList />} />
          <Route exact path="/AdminDashboard/user" element={<VerifyUsers />} />

          <Route exact path="/SalesManager/sales" element={<Sales />} />
          <Route exact path="/SalesManager/SellerAddProduct" element={<SellerAddProduct />} />
          <Route exact path="/SalesManager/UpdateProduct/:productid" element={<UpdateProduct />} />
          <Route exact path="/SalesManager/updateStore" element={<UpdateStore />} />
          <Route exact path="/SalesManager/productList" element={<ProductList />} />

          <Route exact path="/AffiliateDashboard/view" element={<ViewStat />} />
          <Route exact path="/AffiliateDashboard/generateLinks" element={<GenerateLink />} />
          <Route exact path="/products/AffliateSingleProduct/:id/:code" element={<AffiliateSingleProduct />} />
